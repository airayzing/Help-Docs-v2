...
# Groove CRM integration with ChatBotXL

This documentation provides instructions for integrating Groove CRM with ChatBotXL. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Groove CRM.
...
Follow these steps to enable the integration between Groove CRM and ChatBotXL:
