...
# Wealthbox CRM integration with ChatBotXL

## Wealthbox CRM Integration with ChatBotXL

This documentation provides instructions for integrating Wealthbox CRM with ChatBotXL. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Wealthbox CRM.
...
Follow these steps to enable the integration between Wealthbox CRM and ChatBotXL:
