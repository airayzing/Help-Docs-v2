...
Copy the Javascript code from the ChatBotXL app & Go to y
...
2. Make sure ChatBotXL should be the last script to execute, as some scripts may override the ChatBotXL script.
...
After you have logged into your ChatBotXL account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
...
3. Go to Plugins > Add new > Search ChatBotXL > Install now > Activate plugin"
4. Install the "ChatBotXL" Plugin and then activate the same.
5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named "ChatBotXL Snippet" that you Copied from your ChatBotXL account.
7. Save the Settings, and you are all set. ChatBotXL has been integrated into your website.
...
If you have both wp-rocket and ChatBotXL Plugin/Script added to your WordPress site, You may face the issue of the ChatBotXL not showing up on the website.
...
3. Add the ChatBotXL bot script here under `Exclude Java Script Files` option, and done!
...
<summary>What is the minimum browser version requirement for the ChatBotXL website bot?</summary>

ChatBotXL is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
...
<script>
    ...
    scriptEle.src = ('src', 'https://cdn.chatbotxl.online/chatbotxl.js');
    scriptEle.setAttribute('id', 'chatbotxl-messenger-widget');
