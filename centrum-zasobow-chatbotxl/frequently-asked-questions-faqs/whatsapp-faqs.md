...
You can create templates either from the WhatsApp Meta Manager or using the ChatBotXL template tab.
...
No, all charges are conversations based. ChatBotXL platform pricing is based on the plan of conversations you choose.
