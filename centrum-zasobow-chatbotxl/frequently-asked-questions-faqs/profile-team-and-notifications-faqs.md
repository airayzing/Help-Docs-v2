...
You cannot change your email address once you have created your account from the ChatBotXL app. However, You can contact ChatBotXL at production@chatbotxl.co.za to change your email address.

</details>

<details>

<summary>How to delete my ChatBotXL account?</summary>

Once you login to your ChatBotXL account
...
A team in ChatBotXL is people in your organization that will take over for a live chat request. You can add up to three support agents to your team. Moreover, you can give your team access to your account by giving them a separate account with credentials you create in the Team module.
...
<summary>How can a new team member log in to the ChatBotXL?</summary>

A new team member can log in with their assigned credentials on ChatBotXL. You can add three members to the team module on ChatBotXL. The main account owner will have full access to these credentials and can change them as they see fit.
...
4. For example, A New Team member here will log in on app.chatbotxl.com from their email address xyz@gmail.com and the password above.
