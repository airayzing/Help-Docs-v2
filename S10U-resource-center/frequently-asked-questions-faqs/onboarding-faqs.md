---
description: This section deals with key FAQs regarding user onboarding to the S10U
---
...
1. Login to the S10U app using your registered credentials.
...
Facebook Bot is the Integration of your Facebook business page and S10U Application. Once the Integration is completed and active, S10U enables you to run a pre-programmed flow on the Facebook page messenger.

Automated messages are sent to people commenting on your page post and collect leads and many more features. To make the Integration, You will require to provide permissions to S10U to access your pages and manage certain permission.
...
A Telegram bot token is an authentication token/key issued by Telegram. It enables you to access the messages/chat sent on your telegram bot, manage your Telegram contacts, or many more features using the S10U platform.
