...
You can create templates either from the WhatsApp Meta Manager or using the S10U template tab.
...
No, all charges are conversations based. S10U platform pricing is based on the plan of conversations you choose.
