...
# Helpcrunch CRM integration with S10U

This documentation provides step-by-step instructions for integrating Helpcrunch CRM with S10U. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Helpcrunch CRM.
...
Follow these steps to enable the integration between Helpcrunch CRM and S10U:
...
For further assistance, please contact [support team](mailto:production@s10u.co.za).
