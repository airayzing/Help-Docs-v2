...
# Close CRM integration with S10U

This documentation provides step-by-step instructions for integrating Close CRM with S10U. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Close CRM.
...
Follow these steps to enable the integration between Close CRM and S10U:
