...
This integration involves leveraging the capabilities of Google Contacts to manage and organize data collected from various sources, such as online forms, applications, or in this case, from a eleapi.
...
5. **Mapping the Variables:**
   * After authentication, you'll see a screen where you can map the eleapi’s answers to the fields of your Google Contacts.
...
This documentation provides step-by-step instructions for setting up, testing, and disconnecting the Google Contacts integration with a eleapi, along with relevant notes and prerequisites.
