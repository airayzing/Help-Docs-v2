...
You can create templates either from the WhatsApp Meta Manager or using the ChatbotWorld template tab.
...
No, all charges are conversations based. ChatbotWorld platform pricing is based on the plan of conversations you choose.
