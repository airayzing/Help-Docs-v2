---
description: >-
  This page contains the tutorial on how to install the BotBuddy website bot
  on the website.
---

# 📖 Install your Website Chatbot

BotBuddy website bots support all sort of websites. However most common of all is custom build. Here is how you can integrate chatbots on custom-build websites.
...
* Create your bot on the BotBuddy dashboard.
* Design your chatflow and other design settings from the bot setup page.
* Once Done, Go to the BotBuddy setup page and then click on the `Install your Chatbot`
...
You have completed all the heavy lifting. Open your website in private mode (Incognito window) to avoid any cache issues and you will find BotBuddy chatbot on your website.
