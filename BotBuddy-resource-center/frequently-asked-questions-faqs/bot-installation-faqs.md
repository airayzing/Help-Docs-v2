...
Copy the Javascript code from the BotBuddy app & Go to y
...
2. Make sure BotBuddy should be the last script to execute, as some scripts may override the BotBuddy script.
...
After you have logged into your BotBuddy account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
...
3. Go to Plugins > Add new > Search BotBuddy > Install now > Activate plugin"
4. Install the "BotBuddy" Plugin and then activate the same.
5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named "BotBuddy Snippet" that you Copied from your BotBuddy account.
7. Save the Settings, and you are all set. BotBuddy has been integrated into your website.
...
If you have both wp-rocket and BotBuddy Plugin/Script added to your WordPress site, You may face the issue of the BotBuddy not showing up on the website.
...
3. Add the BotBuddy bot script here under `Exclude Java Script Files` option, and done!
...
<summary>What is the minimum browser version requirement for the BotBuddy website bot?</summary>

BotBuddy is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
...
<script>
    ...
    scriptEle.src = ('src', 'https://cdn.botbuddyai.com/BotBuddy.js');
    scriptEle.setAttribute('id', 'BotBuddy-messenger-widget');
