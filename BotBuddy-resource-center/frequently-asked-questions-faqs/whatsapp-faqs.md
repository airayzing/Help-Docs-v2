...
You can create templates either from the WhatsApp Meta Manager or using the BotBuddy template tab.
...
No, all charges are conversations based. BotBuddy platform pricing is based on the plan of conversations you choose.
