...
1. BotBuddy fetches the country and city of a visitor from their IP Address.
...
BotBuddy offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with BotBuddy to set up the calling feature in BotBuddy.
...
5. After you fill out these parameters, you can quickly call leads from BotBuddy.
...
You can add quick replies in the BotBuddy app by following steps:
...
1. BotBuddy offers you the option to transfer the chat to WhatsApp or an agent on your support team.
