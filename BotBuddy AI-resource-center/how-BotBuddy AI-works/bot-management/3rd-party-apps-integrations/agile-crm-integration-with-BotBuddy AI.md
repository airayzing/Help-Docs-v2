...
# Agile CRM integration with BotBuddy AI

## Agile CRM Integration with BotBuddy AI

This documentation provides instructions for integrating Agile CRM with BotBuddy AI. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Agile CRM.
...
Follow these steps to enable the integration between Agile CRM and BotBuddy AI:
