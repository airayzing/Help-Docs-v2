...
# Chakra CRM integration with BotBuddy AI

This documentation provides instructions for integrating Chakra CRM with BotBuddy AI. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Chakra CRM.
...
Follow these steps to enable the integration between Chakra CRM and BotBuddy AI:
