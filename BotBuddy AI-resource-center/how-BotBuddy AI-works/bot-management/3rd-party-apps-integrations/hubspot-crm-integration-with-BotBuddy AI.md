...
# Hubspot CRM integration with BotBuddy AI

This documentation provides instructions for integrating HubSpot CRM with BotBuddy AI. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to HubSpot CRM.
...
Follow these steps to enable the integration between HubSpot CRM and BotBuddy AI:
