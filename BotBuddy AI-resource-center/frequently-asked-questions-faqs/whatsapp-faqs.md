...
You can create templates either from the WhatsApp Meta Manager or using the BotBuddy AI template tab.
...
No, all charges are conversations based. BotBuddy AI platform pricing is based on the plan of conversations you choose.
