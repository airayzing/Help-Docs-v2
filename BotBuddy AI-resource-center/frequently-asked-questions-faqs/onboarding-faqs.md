---
description: This section deals with key FAQs regarding user onboarding to the BotBuddy AI
---
...
If the issue persists, you can contact at support@botbuddyai.com for further assistance.
...
1. Login to the BotBuddy AI app using your registered credentials.
...
Facebook Bot is the Integration of your Facebook business page and BotBuddy AI Application. Once the Integration is completed and active, BotBuddy AI enables you to run a pre-programmed flow on the Facebook page messenger.

Automated messages are sent to people commenting on your page post and collect leads and many more features. To make the Integration, You will require to provide permissions to BotBuddy AI to access your pages and manage certain permission.
...
A Telegram bot token is an authentication token/key issued by Telegram. It enables you to access the messages/chat sent on your telegram bot, manage your Telegram contacts, or many more features using the BotBuddy AI platform.
