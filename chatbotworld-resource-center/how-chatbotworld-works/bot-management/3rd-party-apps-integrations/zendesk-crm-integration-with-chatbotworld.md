...
# Zendesk CRM integration with ChatbotWorld

## Zendesk CRM Integration with ChatbotWorld

This documentation provides instructions for integrating Zendesk CRM with ChatbotWorld. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Zendesk CRM.
...
Follow these steps to enable the integration between Zendesk CRM and ChatbotWorld:
