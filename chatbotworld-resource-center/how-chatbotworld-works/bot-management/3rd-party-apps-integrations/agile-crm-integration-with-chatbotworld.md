...
# Agile CRM integration with ChatbotWorld

## Agile CRM Integration with ChatbotWorld

This documentation provides instructions for integrating Agile CRM with ChatbotWorld. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Agile CRM.
...
Follow these steps to enable the integration between Agile CRM and ChatbotWorld:
