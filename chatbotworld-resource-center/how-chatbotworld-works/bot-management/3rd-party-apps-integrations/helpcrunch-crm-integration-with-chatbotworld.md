...
# Helpcrunch CRM integration with ChatbotWorld

This documentation provides step-by-step instructions for integrating Helpcrunch CRM with ChatbotWorld. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Helpcrunch CRM.
...
Follow these steps to enable the integration between Helpcrunch CRM and ChatbotWorld:
