...
{% hint style="info" %}
Please note: Only the King (Paid) plan have the feature of having more than one team member (i.e. three), if you need more than that, Please request the ChatbotWorld support team for the same.
{% endhint %}
