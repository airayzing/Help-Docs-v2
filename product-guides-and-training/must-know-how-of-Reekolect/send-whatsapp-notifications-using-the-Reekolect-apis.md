...
description: >-
  ...
  from your platform using the Reekolect APIs
---

# 📨 Send WhatsApp notifications using the Reekolect APIs

Before we start, Let's understand the basic workflow.

To create a notification bot with Reekolect, follow these steps:
