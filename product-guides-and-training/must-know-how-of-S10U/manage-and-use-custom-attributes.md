...
Custom attributes in S10U allow you to personalize user interactions and collect specific data. Follow these steps to create and manage custom attributes:

### **Step 1: Navigate to the** S10U **dashboard.**
...
And that's it! You've successfully created a custom attribute in S10U. This attribute can now be used to personalize interactions, segment users, and enhance the overall chatbot experience.
