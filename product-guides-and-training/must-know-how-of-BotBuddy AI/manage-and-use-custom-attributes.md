...
### **Step 1: Navigate to the** BotBuddy AI **dashboard.**
...
And that's it! You've successfully created a custom attribute in BotBuddy AI. This attribute can now be used to personalize interactions, segment users, and enhance the overall chatbot experience.
