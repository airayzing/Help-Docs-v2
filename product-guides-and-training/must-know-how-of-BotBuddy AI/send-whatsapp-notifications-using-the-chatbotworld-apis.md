...
description: >-
  ...
  from your platform using the BotBuddy AI APIs
---

# 📨 Send WhatsApp notifications using the BotBuddy AI APIs

Before we start, Let's understand the basic workflow.

To create a notification bot with BotBuddy AI, follow these steps:
