...
description: >-
  ...
  ChatBotXL Onboarding.
---

# ⚙️ WhatsApp Bot Creation with Automated onboarding

be talkingThis document will guide you through the step-by-step process of creating the ChatBotXL WhatsApp Bot using the WhatsApp Business Cloud API. Following these instructions, you can set up your WhatsApp Bot and integrate it with the ChatBotXL platform.

## **Step 1:** Check for Pre-requisites

Before you begin, ensure you have the necessary prerequisites in place, such as access to the ChatBotXL platform, WhatsApp number, etc.
...
### 2.1 Register your bot on ChatBotXL

1. Login to your ChatBotXL Portal and Click the "Create Bot" button on the top right.
