...
Custom attributes in ChatbotWorld allow you to personalize user interactions and collect specific data. Follow these steps to create and manage custom attributes:

### **Step 1: Navigate to the** ChatbotWorld **dashboard.**
...
And that's it! You've successfully created a custom attribute in ChatbotWorld. This attribute can now be used to personalize interactions, segment users, and enhance the overall chatbot experience.
