...
description: >-
  ...
  from your platform using the BotBuddy APIs
---

# 📨 Send WhatsApp notifications using the BotBuddy APIs

Before we start, Let's understand the basic workflow.

To create a notification bot with BotBuddy, follow these steps:
