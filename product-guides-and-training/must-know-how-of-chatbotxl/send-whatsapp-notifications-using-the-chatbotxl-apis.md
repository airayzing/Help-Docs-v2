...
description: >-
  ...
  from your platform using the ChatBotXL APIs
---

# 📨 Send WhatsApp notifications using the ChatBotXL APIs

Before we start, Let's understand the basic workflow.

To create a notification bot with ChatBotXL, follow these steps:
