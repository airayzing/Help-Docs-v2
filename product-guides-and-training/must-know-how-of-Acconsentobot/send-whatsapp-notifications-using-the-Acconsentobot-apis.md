...
description: >-
  ...
  from your platform using the Acconsentobot APIs
---

# 📨 Send WhatsApp notifications using the Acconsentobot APIs

Before we start, Let's understand the basic workflow.

To create a notification bot with Acconsentobot, follow these steps:
