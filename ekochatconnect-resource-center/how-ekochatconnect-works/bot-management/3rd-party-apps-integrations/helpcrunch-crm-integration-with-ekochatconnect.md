...
# Helpcrunch CRM integration with EkoChat Connect

This documentation provides step-by-step instructions for integrating Helpcrunch CRM with EkoChat Connect. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Helpcrunch CRM.
...
Follow these steps to enable the integration between Helpcrunch CRM and EkoChat Connect:
