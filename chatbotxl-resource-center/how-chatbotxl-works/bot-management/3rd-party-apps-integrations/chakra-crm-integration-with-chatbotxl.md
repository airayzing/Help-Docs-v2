...
# Chakra CRM integration with ChatBotXL

This documentation provides instructions for integrating Chakra CRM with ChatBotXL. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Chakra CRM.
...
Follow these steps to enable the integration between Chakra CRM and ChatBotXL:
