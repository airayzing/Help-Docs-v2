...
# Helpcrunch CRM integration with ChatBotXL

This documentation provides step-by-step instructions for integrating Helpcrunch CRM with ChatBotXL. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Helpcrunch CRM.
...
Follow these steps to enable the integration between Helpcrunch CRM and ChatBotXL:
...
For further assistance, please contact [support team](mailto:pomoc@chatbotxl.com).
