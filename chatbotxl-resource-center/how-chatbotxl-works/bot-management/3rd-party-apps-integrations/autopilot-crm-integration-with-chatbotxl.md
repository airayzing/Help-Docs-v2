...
# Autopilot CRM integration with ChatBotXL

## Autopilot CRM Integration with ChatBotXL

This documentation provides instructions for integrating Autopilot CRM with ChatBotXL. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Autopilot CRM.
...
Follow these steps to enable the integration between Autopilot CRM and ChatBotXL:
