...
1. ChatBotXL fetches the country and city of a visitor from their IP Address.
...
ChatBotXL offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with ChatBotXL to set up the calling feature in ChatBotXL.
...
4. Also, you can contact us at production@chatbotxl.co.za for further assistance.
5. After you fill out these parameters, you can quickly call leads from ChatBotXL.
...
You can add quick replies in the ChatBotXL app by following steps:
...
1. ChatBotXL offers you the option to transfer the chat to WhatsApp or an agent on your support team.
