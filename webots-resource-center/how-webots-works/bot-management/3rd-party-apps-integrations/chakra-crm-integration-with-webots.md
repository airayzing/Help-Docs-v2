...
# Chakra CRM integration with WeBots

This documentation provides instructions for integrating Chakra CRM with WeBots. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Chakra CRM.
...
Follow these steps to enable the integration between Chakra CRM and WeBots:
