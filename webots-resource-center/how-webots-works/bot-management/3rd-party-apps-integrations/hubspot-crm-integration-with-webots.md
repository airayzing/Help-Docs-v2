...
# Hubspot CRM integration with WeBots

This documentation provides instructions for integrating HubSpot CRM with WeBots. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to HubSpot CRM.
...
Follow these steps to enable the integration between HubSpot CRM and WeBots:
