...
# Autopilot CRM integration with WeBots

## Autopilot CRM Integration with WeBots

This documentation provides instructions for integrating Autopilot CRM with WeBots. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Autopilot CRM.
...
Follow these steps to enable the integration between Autopilot CRM and WeBots:
