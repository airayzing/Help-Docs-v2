...
# Nutshell CRM integration with WeBots

This documentation provides instructions for integrating Nutshell CRM with WeBots. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Nutshell CRM.
...
Follow these steps to enable the integration between Nutshell CRM and WeBots:
