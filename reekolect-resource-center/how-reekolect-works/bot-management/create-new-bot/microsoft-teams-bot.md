...
5. After the bot is created, enter the following Webhook endpoint address and click **"Save"** to proceed://ASK WHAT TO ADD\
...
3. Fill in the basic details of the app as follows:
   ...
   7. **Website (must be a valid HTTPS URL)**: [https://reekolect.com/](https://reekolect.com/)
