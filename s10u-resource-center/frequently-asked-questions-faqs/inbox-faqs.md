...
1. S10U AI Studio fetches the country and city of a visitor from their IP Address.
...
S10U AI Studio offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with S10U AI Studio to set up the calling feature in S10U AI Studio.
...
5. After you fill out these parameters, you can quickly call leads from S10U AI Studio.
...
You can add quick replies in the S10U AI Studio app by following steps:
...
1. S10U AI Studio offers you the option to transfer the chat to WhatsApp or an agent on your support team.
