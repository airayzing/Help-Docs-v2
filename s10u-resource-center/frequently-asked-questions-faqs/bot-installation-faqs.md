...
Copy the Javascript code from the S10U AI Studio app & Go to y
...
2. Make sure S10U AI Studio should be the last script to execute, as some scripts may override the S10U AI Studio script.
...
After you have logged into your S10U AI Studio account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
...
3. Go to Plugins > Add new > Search S10U AI Studio > Install now > Activate plugin"
4. Install the "S10U AI Studio" Plugin and then activate the same.
5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named "S10U AI Studio Snippet" that you Copied from your S10U AI Studio account.
7. Save the Settings, and you are all set. S10U AI Studio has been integrated into your website.
...
If you have both wp-rocket and S10U AI Studio Plugin/Script added to your WordPress site, You may face the issue of the S10U AI Studio not showing up on the website.
...
3. Add the S10U AI Studio bot script here under `Exclude Java Script Files` option, and done!
...
<summary>What is the minimum browser version requirement for the S10U AI Studio website bot?</summary>

S10U AI Studio is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
...
<script>
    ...
    scriptEle.src = ('src', 'https://cdn.s10u.ai/s10u.js');
    scriptEle.setAttribute('id', 's10u-messenger-widget');
...
<img src="https://github.com/ais10u/GitBook-Sync/blob/aman-help-changes/.gitbook/assets/image%20(24).png" alt="" data-size="original">
