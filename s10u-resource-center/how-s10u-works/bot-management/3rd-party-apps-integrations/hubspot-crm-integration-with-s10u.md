...
# Hubspot CRM integration with S10U AI Studio

This documentation provides instructions for integrating HubSpot CRM with S10U AI Studio. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to HubSpot CRM.
...
Follow these steps to enable the integration between HubSpot CRM and S10U AI Studio:
