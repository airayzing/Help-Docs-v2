...
The **Inbox User Import API** allows you to import WhatsApp contacts into the S10U platform. You can use this API to create or update WhatsApp contacts with various attributes and contact information.
...
The Inbox User Import API allows you to easily import user profiles into the S10U platform. Make sure to follow the authentication and data format guidelines for successful imports.
