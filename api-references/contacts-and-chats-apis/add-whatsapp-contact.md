...
The **Inbox User Import API** allows you to import WhatsApp contacts into the S10U AI Studio platform. You can use this API to create or update WhatsApp contacts with various attributes and contact information.
...
curl 'https://api.v7.express-chat.com/inbox/users/import' \
  ...
  -H 'Accept: */*' \
  -H 'Origin: https://app.s10u.ai' \
  -H 'Referer: https://app.s10u.ai/' \
...
The Inbox User Import API allows you to easily import user profiles into the S10U AI Studio platform. Make sure to follow the authentication and data format guidelines for successful imports.
