...
The team will be required to create and get the templates approved by the Facebook WhatsApp Business Manager or Acconsentobot Dashboard. Once It is done,

1. Go to Acconsentobot Panel
...
1. Go to the Acconsentobot Dashboard ( [https://app.Acconsentobot.ai//](https://app.Acconsentobot.com/) )
