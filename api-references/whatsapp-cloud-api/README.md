...
The team will be required to create and get the templates approved by the Facebook WhatsApp Business Manager or Reekolect Dashboard. Once It is done,

1. Go to Reekolect Panel
...
1. Go to the Reekolect Dashboard ( [https://app.reekolect.ai//](https://app.Reekolect.com/) )
