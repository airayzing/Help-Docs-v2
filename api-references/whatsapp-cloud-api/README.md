...
The team will be required to create and get the templates approved by the Facebook WhatsApp Business Manager or S10U AI Studio Dashboard. Once It is done,

1. Go to S10U AI Studio Panel
...
1. Go to the S10U AI Studio Dashboard ( [https://app.s10u.ai/](https://app.s10u.com/) )
