...
The team will be required to create and get the templates approved by the Facebook WhatsApp Business Manager or Romulus Dashboard. Once It is done,

1. Go to Romulus Panel
...
1. Go to the Romulus Dashboard ( [https://chat.romulus.live/](https://app.Romulus.com/) )
