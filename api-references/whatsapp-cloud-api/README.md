...
The team will be required to create and get the templates approved by the Facebook WhatsApp Business Manager or ChatbotWorld Dashboard. Once It is done,

1. Go to ChatbotWorld Panel
...
1. Go to the ChatbotWorld Dashboard ( [https://app.chatbotworld.io/](https://app.chatbotworld.com/) )
