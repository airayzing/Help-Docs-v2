---
description: >-
  Here is the information for using the settings done inside teams in your bot
  to assign chat
---
...
## Setting up Assign Chat logics <a href="#setting-up-assign-chat-logics" id="setting-up-assign-chat-logics"></a>
