...
# Autopilot CRM integration with Acconsentobot

## Autopilot CRM Integration with Acconsentobot

This documentation provides instructions for integrating Autopilot CRM with Acconsentobot. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Autopilot CRM.
...
Follow these steps to enable the integration between Autopilot CRM and Acconsentobot:
