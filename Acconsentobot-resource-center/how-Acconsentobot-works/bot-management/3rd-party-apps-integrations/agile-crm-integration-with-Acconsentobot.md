...
# Agile CRM integration with Acconsentobot

## Agile CRM Integration with Acconsentobot

This documentation provides instructions for integrating Agile CRM with Acconsentobot. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Agile CRM.
...
Follow these steps to enable the integration between Agile CRM and Acconsentobot:
