---
description: This section deals with key FAQs regarding user onboarding to the Acconsentobot
---
...
If the issue persists, you can contact at  https://acconsentobot.click/ for further assistance.
...
1. Login to the Acconsentobot app using your registered credentials.
...
Facebook Bot is the Integration of your Facebook business page and Acconsentobot Application. Once the Integration is completed and active, Acconsentobot enables you to run a pre-programmed flow on the Facebook page messenger.

Automated messages are sent to people commenting on your page post and collect leads and many more features. To make the Integration, You will require to provide permissions to Acconsentobot to access your pages and manage certain permission.
...
A Telegram bot token is an authentication token/key issued by Telegram. It enables you to access the messages/chat sent on your telegram bot, manage your Telegram contacts, or many more features using the Acconsentobot platform.
