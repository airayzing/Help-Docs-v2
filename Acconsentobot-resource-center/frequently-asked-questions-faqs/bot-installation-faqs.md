...
Copy the Javascript code from the Acconsentobot app & Go to y
...
2. Make sure Acconsentobot should be the last script to execute, as some scripts may override the Acconsentobot script.
...
After you have logged into your Acconsentobot account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
...
3. Go to Plugins > Add new > Search Acconsentobot > Install now > Activate plugin"
4. Install the "Acconsentobot" Plugin and then activate the same.
5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
6. Once your Plugin is activated, paste the Acconsentobot API key in the Box named "Acconsentobot Snippet" that you Copied from your Acconsentobot account.
7. Save the Settings, and you are all set. Acconsentobot has been integrated into your website.
...
If you have both wp-rocket and Acconsentobot Plugin/Script added to your WordPress site, You may face the issue of the Acconsentobot not showing up on the website.
...
3. Add the Acconsentobot bot script here under `Exclude Java Script Files` option, and done!
...
<summary>What is the minimum browser version requirement for the Acconsentobot website bot?</summary>

Acconsentobot is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
...
<script>
    ...
    scriptEle.src = ('src', 'https://cdn.Acconsentobot.online/Acconsentobot.js');
    scriptEle.setAttribute('id', 'Acconsentobot-messenger-widget');
