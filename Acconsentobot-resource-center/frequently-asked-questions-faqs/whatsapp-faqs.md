...
You can create templates either from the WhatsApp Meta Manager or using the Acconsentobot template tab.
...
No, all charges are conversations based. Acconsentobot platform pricing is based on the plan of conversations you choose.
