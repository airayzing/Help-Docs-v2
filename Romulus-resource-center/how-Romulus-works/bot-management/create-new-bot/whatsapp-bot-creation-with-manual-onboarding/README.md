...
This document will guide you through the step-by-step process of creating the Romulus WhatsApp Bot using the WhatsApp Business Cloud API. By following these instructions, you can set up your WhatsApp Bot and integrate it with the Romulus platform.

#### **Step 1:** Check for Pre-requisites

Before you begin, ensure you have the necessary prerequisites in place, such as access to the Romulus platform and a WhatsApp Business Cloud API account.
...
1. Begin by creating a Meta App for your WhatsApp Bot on the Romulus platform.
...
1. Register and verify the WhatsApp number that you want to use for your RomulusWhatsApp Bot.
...
#### **Step 4:** Subscribe WA Webhook with Romulus

1. Subscribe the WhatsApp (WA) web hook with the Romulus platform.
2. This will enable your WhatsApp Bot to receive messages and interact with users.

{% content-ref url="subscribe-wa-webhook-with-Romulus.md" %}
[subscribe-wa-webhook-with-Romulus.md](subscribe-wa-webhook-with-Romulus.md)
{% endcontent-ref %}
...
2. Retrieve all the necessary details required for integrating with the Romulus platform.
