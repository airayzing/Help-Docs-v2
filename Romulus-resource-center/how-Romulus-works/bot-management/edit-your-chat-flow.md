...
A chat flow determines the structure of conversations between your chatbot and users. This document provides instructions on how to customize chat flows using the available tools and functionalities within the Romulus platform.

## **Accessing Chatbot Builder**

To customize your chatbot's flow, follow these steps:

* Navigate to the bot menu or homepage on the Romulus portal.
...
If you encounter any issues or need assistance, please contact us at [support@romulus.live](mailto:support@romulus.live). We will respond within 48 business hours.
