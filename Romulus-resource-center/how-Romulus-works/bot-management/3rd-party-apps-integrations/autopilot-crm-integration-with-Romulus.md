...
# Autopilot CRM integration with Romulus

## Autopilot CRM Integration with Romulus

This documentation provides instructions for integrating Autopilot CRM with Romulus. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Autopilot CRM.
...
Follow these steps to enable the integration between Autopilot CRM and Romulus:
