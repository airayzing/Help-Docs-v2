...
# Agile CRM integration with Romulus

## Agile CRM Integration with Romulus

This documentation provides instructions for integrating Agile CRM with Romulus. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to Agile CRM.
...
Follow these steps to enable the integration between Agile CRM and Romulus:
