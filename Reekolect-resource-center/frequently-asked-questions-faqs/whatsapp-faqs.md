...
You can create templates either from the WhatsApp Meta Manager or using the Reekolect template tab.
...
No, all charges are conversations based. Reekolect platform pricing is based on the plan of conversations you choose.
