...
1. Reekolect fetches the country and city of a visitor from their IP Address.
...
Reekolect offers an integration with Twilio to call your leads from the Inbox. You can use the call feature to call leads and customers from the leads section directly from your desktop. You must integrate Twilio with Reekolect to set up the calling feature in Reekolect.
...
4. Also, you can contact us at production@Reekolect.co.za for further assistance.
5. After you fill out these parameters, you can quickly call leads from Reekolect.
...
You can add quick replies in the Reekolect app by following steps:
...
1. Reekolect offers you the option to transfer the chat to WhatsApp or an agent on your support team.
