...
Copy the Javascript code from the Reekolect app & Go to y
...
2. Make sure Reekolect should be the last script to execute, as some scripts may override the Reekolect script.
...
After you have logged into your Reekolect account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
...
If you have both wp-rocket and Reekolect Plugin/Script added to your WordPress site, You may face the issue of the Reekolect not showing up on the website.
...
3. Add the Reekolect bot script here under `Exclude Java Script Files` option, and done!
...
<summary>What is the minimum browser version requirement for the Reekolect website bot?</summary>

Reekolect is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
...
<script>
    ...
    scriptEle.src = ('src', 'https://cdn.Reekolect.online/Reekolect.js');
    scriptEle.setAttribute('id', 'Reekolect-messenger-widget');
