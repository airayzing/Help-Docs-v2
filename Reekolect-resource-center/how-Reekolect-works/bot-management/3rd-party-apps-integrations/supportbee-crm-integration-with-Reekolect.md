...
This documentation provides instructions for integrating SupportBee CRM with Reekolect. By following these steps, you'll be able to seamlessly send lead details such as Name, Email, and Phone to SupportBee CRM.
...
Follow these steps to enable the integration between SupportBee CRM and Reekolect:
