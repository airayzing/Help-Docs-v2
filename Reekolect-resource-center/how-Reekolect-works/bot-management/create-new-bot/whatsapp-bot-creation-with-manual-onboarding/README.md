...
1. Begin by creating a Meta App for your WhatsApp Bot on the Reekolect platform.
...
#### **Step 4:** Subscribe WA Webhook with Reekolect

1. Subscribe the WhatsApp (WA) web hook with the Reekolect platform.
2. This will enable your WhatsApp Bot to receive messages and interact with users.

{% content-ref url="subscribe-wa-webhook-with-Reekolect.md" %}
[subscribe-wa-webhook-with-Reekolect.md](subscribe-wa-webhook-with-Reekolect.md)
{% endcontent-ref %}
...
2. Retrieve all the necessary details required for integrating with the Reekolect platform.
